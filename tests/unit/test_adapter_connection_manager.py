...
class BaseConnectionManagerTest(unittest.TestCase):
    def setUp(self):
        self.vertica_credentials = verticaCredentials(
            host="172.16.120.10",
            username="dbadmin",
            port=5433,
    ...
    def test_retry_connection(self):
        ...
        This test uses a Connection populated with test verticaCredentials values, and
...
class VerticaConnectionManagerTest(unittest.TestCase):
    ...
    def test_open(self):
        ...
        expects a mock connect to raise a pvertica_python.errors.ConnectionFailure
        ...
        * The resulting attempt count should be 4.
        ...
        def connect(*args, **kwargs):
            ...
            if attempt <= 2:
                raise vertica_python.errors.ConnectionFailure("Connection has failed")
